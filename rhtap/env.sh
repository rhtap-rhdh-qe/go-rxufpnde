...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap_qe/go-rxufpnde:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/go-rxufpnde-gitops
...
export IMAGE_REGISTRY_USER="rhtap_qe+rhtap_qe_ci"
export COSIGN_PUBLIC_KEY="LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFY2lRM0U4VjBsaitQN2p5b0diRWh3UDNIdnVJYwp5QXNIbVNvcGNxd0RjQzZtUEdhVURsTFlYbXN6T2I2K3pEcjZodnFuV3V4dEcyNWRRQ25namxKZWdBPT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0tCg=="
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.rosa.kx-619ade0793.atce.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.rosa.kx-619ade0793.atce.p3.openshiftapps.com}
